...
Python utilities for Debezium CDC events — direct port + extension of PR #400.
...
def struct_to_dict(
    ...
    # ── Post-process: coerce any bytes values to hex string for JSON compat ──
...
class SourceRecordExtractor:
    ...
    # ── Typed access via topic_class_map ────────────────────────────────────
